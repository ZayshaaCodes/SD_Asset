...
//todo: extract tools from editor window so that new tools can be added easily
//will require a new tool class, it can include an iTool interface with the following
//methods: 
