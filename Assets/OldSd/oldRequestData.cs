...
{
    static oldRequestData() => fieldInfo = typeof(oldRequestData).GetFields(BindingFlags.Instance | BindingFlags.Public);
    private static        FieldInfo[] fieldInfo;

    [Range(0, 1)] public  float       denoising_strength = .5f;
    public                StableDiffusion.SdResizeMode  resize_mode        = 0;
    ...
    [RangeStepInt(128, 512,  128)] public int             firstphase_width         = 0;
    [RangeStepInt(128, 512,  128)] public int             firstphase_height        = 0;
        ...
        foreach (var field in fieldInfo)
        {
            ...
            switch (value)
            {
                case Texture2D texture:
                    // var s = texture != null ? "image/png;base64," + texture.Tob64String() : "";
