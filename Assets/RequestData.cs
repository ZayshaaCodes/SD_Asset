...
[Serializable]
public class Txt2ImgRequestData
{
    static FieldInfo[] fieldInfo;
    static Txt2ImgRequestData() => fieldInfo = typeof(Txt2ImgRequestData).GetFields(BindingFlags.Instance | BindingFlags.Public);
...
[Serializable]
public class Img2ImgRequestData : Txt2ImgRequestData
{
    static FieldInfo[] fieldInfo;
    static Img2ImgRequestData() => fieldInfo = typeof(Img2ImgRequestData).GetFields(BindingFlags.Instance | BindingFlags.Public);
    ...
    public override byte[] GetFieldDataBytes()
    {
        return Encoding.UTF8.GetBytes(SerializeFields());
    }
}